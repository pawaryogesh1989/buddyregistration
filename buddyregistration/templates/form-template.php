...
?>" name="signup_form" id="signup_form" class="standard-form" method="post" enctype="multipart/form-data">
    ...
    if ('request-details' == bp_get_current_signup_step()):
        ...
        <div class="register-section" id="basic-details-section">
            ...
            ?>" <?php
                   bp_form_field_attributes('username');
                   ?>/>
            ...
            ?>
            <input type="email" name="signup_email" id="signup_email" value="<?php
            bp_signup_email_value();
            ?>" <?php
                   bp_form_field_attributes('email');
                   ?>/>
            ...
            ?>
            <input type="password" name="signup_password" id="signup_password" value="" class="password-entry" <?php
